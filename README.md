...
|---|---|---|
|Data|database|`raw`: original data; `retail_analysis`: database generated by SQL scripts; `sqlexport`: data exported by SQL scripts; `pyexport`: data exported by Python scripts|
...
|Environment Info|repository root|`environment.txt`: project environment info; `extensions.json`: recommended VSCode extensions|
...
**Competition link:** [https://tianchi.aliyun.com/dataset/97652](https://tianchi.aliyun.com/dataset/97652)
